  ...
  <div className='max-w-7xl mx-auto px-8 py-12'>
    ...
    <div className='grid grid-cols-1 md:grid-cols-3 gap-10 mb-8'>
      ...
      <div className='md:col-span-1'>
        <h4 className='text-gray-900 font-semibold mb-4 text-lg'>Blood Donation Portal</h4>
        <p className='text-gray-600 text-sm leading-relaxed mb-4'>
          Saving lives through blood donation. Join our community of heroes making a difference every day.
        </p>
        ...
        <div className='bg-red-50 border border-red-200 rounded-lg p-4 mb-4'>
          <div className='flex items-center gap-2'>
            ...
            <span className='text-red-600 text-sm font-semibold'>24/7 Emergency Service Available</span>
          </div>
        </div>

        
        <div>
          <p className='text-gray-700 text-sm font-semibold mb-3'>Follow Us</p>
          <div className='flex gap-3'>
            <a href="#" className='h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-red-500 hover:text-white transition-all duration-300 hover:scale-110'>
    ...
    <div className='border-t border-gray-200 pt-6'>
      <div className='flex flex-col md:flex-row justify-between items-center gap-4'>
        ...
        <p className='text-gray-500 text-sm text-center md:text-left'>
          © 2026 <span className='text-red-500 font-semibold'>Blood Donation Portal</span>. Saving Lives Together.
        </p>

        
        <div className='flex flex-wrap justify-center gap-4 text-xs text-gray-500'>
          <Link to="/terms" className='hover:text-red-500 transition-colors duration-300'>Terms of Service</Link>
          <span className='hidden md:inline'>•</span>
          <Link to="/privacy" className='hover:text-red-500 transition-colors duration-300'>Privacy Policy</Link>
          <span className='hidden md:inline'>•</span>
          <Link to="/guidelines" className='hover:text-red-500 transition-colors duration-300'>Donation Guidelines</Link>
        </div>
      </div>
    </div>
  </div>
